...
namespace TJ
{
    public class BattleSceneManager : MonoBehaviour
    {
        ...
        [Header("UI")] public Button endTurnButton;
        ...
        public void BeginBattle(GameObject[] prefabsArray)
        {
            ...
            if (gameManager.PlayerHasRelic(RelicType.Anchor))
                player.AddBlock(10);

            if (gameManager.PlayerHasRelic(RelicType.Lantern))
                energy += 1;
        ...
        public void EndFight(bool win)
        {
            ...
            if (gameManager.PlayerHasRelic(RelicType.BurningBlood))
            {
        ...
        public void HandleEndScreen()
        {
            ...
            endScreen.goldReward.relicName.text = enemies[0].goldDrop + " Gold";
